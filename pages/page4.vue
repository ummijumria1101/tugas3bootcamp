<template>
    <div class="flex">
        ...
        <h1 class="text-center text-4xl font-semibold text-primarycolor p-4">Tabel Data Antena</h1>
        <table>
            <thead>
                <tr class=""> <!-- table row -->
                    <th class="p-10">Nama Antena</th>
                    <th class="p-10">Deskripsi</th>
                    <th class="p-10">Stok</th>
                    <th class="p-10">Harga Pasaran</th>
                    <th class="p-10">Diskon</th>
                    <th class="p-10">Harga Setelah Diskon</th>
                    <th class="p-10">Image</th>
                </tr>
            </thead>
